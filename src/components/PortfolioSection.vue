<template>
  <div id="portfolio">
    <span align="center">
      <h1 class="mb-5">Portfolio and Open source</h1>
      <p>
            ...
            <div class="pa-2">
              <v-card class="mx-auto" max-width="344">
                ...
                <v-card-title>
                  {{ project.name }}
                  <a
                    v-if="project.liveView"
                    :href="project.liveView"
                    target="_blank"
                  >
                    <v-badge
                      :link="project.liveView"
                      content="Live view"
                      inline
                      overlap
                      color="#2e8b57"
                ...
                <v-card-subtitle>
                  <v-icon small class="mt-n1">mdi-calendar</v-icon>
                  {{ project.date }}
                </v-card-subtitle>
